...
2& HIGH & 7 &                   &Planned   & 18-09-2020 &Access the system\\ \cline{1-3} \cline{5-7} 
3& HIGH & 8 &                   &Planned   & 20-09-2020 &Access the account\\ \cline{1-3} \cline{5-7} 
4&MEDIUM  & 8 &                   &Planned   & 23-09-2020 &View companies\\
\cline{1-3} \cline{5-7}
5& HIGH & 5 &                   &Planned   & 27-09-2020 &Manage companies \\ \cline{1-3} \cline{5-7}  \cline{1-3} \cline{5-7}
\hline
6& HIGH & 7 & \multirow{5}{*}{2}&Planned   & 30-09-2020 &Add job vaccanices\\ \cline{1-3} \cline{5-7} 
7& HIGH & 6 &                   &Planned   & 04-10-2020 &Manage jobs  \\ \cline{1-3} \cline{5-7} 

8& MEDIUM & 10 &                   &Planned   & 10-10-2020 &Search jobs,View jobs,Apply job,View job applications\\ \cline{1-3} \cline{5-7} 
9& HIGH & 6 &                   &Planned   & 11-10-2020 & Manage posted jobs\\
\cline{1-3} \cline{5-7} \hline

10& HIGH & 9 & \multirow{5}{*}{3}&Planned   & 14-10-2020 &View applications,Download Resumes \\ \cline{1-3} \cline{5-7} 
11& MEDIUM & 6 &                   &Planned   & 19-10-2020 & Create exams,Add questions \\ \cline{1-3} \cline{5-7} 
12& HIGH & 6 &                   &Planned   &22-10-2020 &Create tasks\\
\cline{1-3} \cline{5-7} 

13& MEDIUM & 6 &                   &Planned   & 26-10-2020 &Attend exams   \\ \cline{1-3} \cline{5-7}
\hline                         
\end{tabular}
\end{center}
\pagebreak
...
\begin{center}
	\begin{tabular}{ | p {1.3 cm} | p {2.3 cm} | p {1 cm} |  p {1.4 cm} |  p {2.3 cm} |  p {2.0 cm} |  p {2.8 cm} | }
		...
		\bf RELEASE GOAL \\
		\hline
			14& MEDIUM & 10 & \multirow{5}{*}{4}&Planned   & 28-10-2020 &View Candidates \\ \cline{1-3} \cline{5-7} 
		15&HIGH & 10 & &Planned   & 31-10-2020 &Attend task\\ \cline{1-3} \cline{5-7}
		
		16& MEDIUM & 7 &                   &Planned   & 02-11-2020 &Understand knowledge, skills of candidates\\ \cline{1-3} \cline{5-7} 
		
		17& HIGH & 8 &                   &Planned   & 05-11-2020 &Send/Receive Messages\\ \cline{1-3} \cline{5-7}
		
		18& HIGH & 8 &                   &Planned   & 08-11-2020 &Update Profile, Change password\\ \cline{1-3} \cline{5-7} \hline   
	\end{tabular}
...
\begin{center}
	\begin{tabular}{ | p {1.5 cm} | p {7.0 cm} | p {7.0 cm} |   }
		
		\hline 
	\bf 	User story ID & \bf Comments from scrum master if any & \bf Comments from product owner if any \\
		\hline
		1 & satisfied & satisfied\\ \hline
		2 & completed & Data enter in registration form must preserve whenever an error occure during the form validation time. 
		\\ \hline
...
\begin{center}
	...
	\end{tabular}
	\captionof{table}{ReplyMailBox Table}
\end{center}
